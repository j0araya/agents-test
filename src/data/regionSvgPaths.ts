// SVG path data extracted from individual region SVG files.
// Each key matches the region slug used in the database.
// All paths share the same viewBox: 0 0 200 640
